/**
 * A synchronous, portable SHA-256 implementation keeps browser renderers from
 * importing Node built-ins while preserving identical hashes across runtimes.
 */
...
function portableSha256Hex(text: string): string {
